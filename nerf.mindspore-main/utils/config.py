...
def get_config():
    ...
    parser.add_argument("--name", default="exp_text", type=str, help="experiment name")
    parser.add_argument(
        "--base_dir",
        type=str,
        default="./results/",
    ...
    # Training options
    parser.add_argument("--cap_n_iters", type=int, default=2001, help="max training iterations")
    ...
    parser.add_argument("--i_ckpt", type=int, default=500, help="frequency of ckpt saving")
    parser.add_argument("--i_testset", type=int, default=500, help="frequency of testset saving")
    parser.add_argument("--ckpt", type=str, default=None, help="the path of external checkpoint")
    parser.add_argument(
        "--mode",
        type=str,
        default="PYNATIVE_MODE",
